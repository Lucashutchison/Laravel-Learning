 ...
 <form action="/ideas/{{ $idea->id }}" method="POST">
    ...
    <div class="col-span-full data-theme caramelatte">
          ...
          <div class="mt-2">
            ...
            <label for="state" class="block text-2xl/6 font-medium mt-4">Current State: {{ $idea->state }}</label>
                <select id="state" name="state" class="mt-4 select select-bordered w-full max-w-xs">
          ...
          <p class="mt-3 text-sm/6">Update Idea?</p>
